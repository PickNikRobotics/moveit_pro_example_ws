 ...
 *
 * Floored at a duration worth executing, and otherwise unbounded: a segment whose budgets need
 * longer than the caller allows is rejected there, not run faster than the budgets permit.
 */
...
/**
 * @brief Plans one segment of the cube stacking oracle as a joint-space trajectory.
 */
