...
public:
  ...
  {
    moveit_studio::behaviors::registerBehavior<ExamplePublishTextMarker>(factory, "ExamplePublishTextMarker",
                                                                         shared_resources);
    moveit_studio::behaviors::registerBehavior<ExamplePublishArrowMarker>(factory, "ExamplePublishArrowMarker",
                                                                          shared_resources);
  }
};
}  // namespace example_behaviors
