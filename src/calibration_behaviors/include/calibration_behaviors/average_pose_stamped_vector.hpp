...
public:
   ...
   * @return calibrate_camera_pose does not use expose any ports, so this function returns an empty list.
   */
   ...
   * AveragePoseStampedVector is derived from BT::SyncActionNode, it is very important that its tick() function always
