...
TEST(BehaviorTests, test_load_behavior_plugins)
{
  ...
  BT::BehaviorTreeFactory factory;
  {
    auto plugin_instance =
        class_loader.createUniqueInstance("calibrate_camera_pose::CalibrateCameraPoseBehaviorsLoader");
  ...
  EXPECT_NO_THROW(
      (void)factory.instantiateTreeNode("test_behavior_name", "CalibrateCameraPose", BT::NodeConfiguration()));
}
