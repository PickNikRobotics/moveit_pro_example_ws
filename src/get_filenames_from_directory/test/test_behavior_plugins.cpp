...
TEST(BehaviorTests, test_load_behavior_plugins)
{
  ...
  BT::BehaviorTreeFactory factory;
  {
    auto plugin_instance =
        class_loader.createUniqueInstance("get_filenames_from_directory::GetFilenamesFromDirectoryBehaviorsLoader");
  ...
  EXPECT_NO_THROW(
      (void)factory.instantiateTreeNode("test_behavior_name", "GetFilenamesFromDirectory", BT::NodeConfiguration()));
}
