...
TEST(BehaviorTests, test_load_behavior_plugins)
{
  ...
  BT::BehaviorTreeFactory factory;
  {
    auto plugin_instance =
        class_loader.createUniqueInstance("distance_to_collision::DistanceToCollisionBehaviorsLoader");
  ...
  EXPECT_NO_THROW(
      (void)factory.instantiateTreeNode("test_behavior_name", "DistanceToCollision", BT::NodeConfiguration()));
}
