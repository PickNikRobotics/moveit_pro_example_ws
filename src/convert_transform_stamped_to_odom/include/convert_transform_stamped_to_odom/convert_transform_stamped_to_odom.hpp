...
{
/**
 * @brief Converts a geometry_msgs::msg::TransformStamped message into a nav_msgs::msg::Odometry message.
 */
class ConvertTransformStampedToOdom : public moveit_studio::behaviors::SharedResourcesNode<BT::SyncActionNode>
{
public:
  /**
   * @brief Constructor for the convert_transform_stamped_to_odom behavior.
   ...
   */
  ConvertTransformStampedToOdom(const std::string& name, const BT::NodeConfiguration& config, const std::shared_ptr<moveit_studio::behaviors::BehaviorContext>& shared_resources);

  /**
   * @brief Implementation of the required providedPorts() function for the convert_transform_stamped_to_odom Behavior.
   ...
   * @return A BT::PortsList containing the input port for TransformStamped and output port for Odometry.
   */
  ...
  /**
   * @brief Implementation of BT::SyncActionNode::tick() for ConvertTransformStampedToOdom.
