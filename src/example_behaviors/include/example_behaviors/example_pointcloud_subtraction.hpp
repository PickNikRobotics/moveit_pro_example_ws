 ...
 * @brief TODO(...)
 */
class ExamplePointCloudSubtraction : public moveit_studio::behaviors::AsyncBehaviorBase
{
public:
  /**
   ...
   */
  ExamplePointCloudSubtraction(const std::string& name, const BT::NodeConfiguration& config,
