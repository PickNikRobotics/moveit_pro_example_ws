...
{
ExampleSetupMtcPickFromPose::ExampleSetupMtcPickFromPose(
...
BT::PortsList ExampleSetupMtcPickFromPose::providedPorts()
{
  return {
...
BT::NodeStatus ExampleSetupMtcPickFromPose::tick()
{
