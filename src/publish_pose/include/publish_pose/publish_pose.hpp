...
public:
  /**
   * @brief Constructor for the publish_pose behavior.
  ...
  /**
   * @brief Implementation of the required providedPorts() function for the publish_pose Behavior.
   ...
   * @return publish_pose does not expose any ports, so this function returns an empty list.
   */
  ...
  /**
   * @brief Implementation of BT::SyncActionNode::tick() for PublishPose.
